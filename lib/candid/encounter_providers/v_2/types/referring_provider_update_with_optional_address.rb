...
module Candid
  module EncounterProviders
    module V2
      module Types
        class ReferringProviderUpdateWithOptionalAddress < Internal::Types::Model
          ...
          field :secondary_identification, -> { Candid::EncounterProviders::V2::Types::ReferringProviderSecondaryIdentificationOptional }, optional: true, nullable: false
        end
      end
    end
  end
