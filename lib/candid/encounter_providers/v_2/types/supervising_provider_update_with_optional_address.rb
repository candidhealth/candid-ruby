...
module Candid
  module EncounterProviders
    module V2
      module Types
        class SupervisingProviderUpdateWithOptionalAddress < Internal::Types::Model
          ...
          field :secondary_identification, -> { Candid::EncounterProviders::V2::Types::SupervisingProviderSecondaryIdentificationOptional }, optional: true, nullable: false
        end
      end
    end
  end
