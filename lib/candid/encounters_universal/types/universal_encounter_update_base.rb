  ...
  module EncountersUniversal
    module Types
      class UniversalEncounterUpdateBase < Internal::Types::Model
        ...
        field :existing_medications, -> { Internal::Types::Array[Candid::Encounters::V4::Types::Medication] }, optional: true, nullable: false
        ...
        field :initial_referring_provider, -> { Candid::EncounterProviders::V2::Types::InitialReferringProviderUpdate }, optional: true, nullable: false
        field :referring_provider, -> { Candid::EncounterProviders::V2::Types::ReferringProviderUpdate }, optional: true, nullable: false
