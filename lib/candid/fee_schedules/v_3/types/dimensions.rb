...
module Candid
  module FeeSchedules
    module V3
      module Types
        # Dimension values that qualify a rate. For the optional dimensions, a null value signifies "all apply". For
        # set-type dimensions, an empty set signifies "all apply". Only one of, but not both, of `network_types` and
        # `payer_plan_group_id` may be populated.
