...
module Candid
  module FeeSchedules
    module V3
      module Types
        # A comprehensive rate including the current rate value and all values for historic time ranges. The time ranges
        # specified by each RateEntry are disjoint.  A rate must always have at least one entry.
