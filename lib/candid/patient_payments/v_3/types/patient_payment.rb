    ...
    module V3
      module Types
        class PatientPayment < Internal::Types::Model
          ...
          field :source, -> { Candid::PatientPayments::V3::Types::PatientPaymentSource }, optional: false, nullable: false
          field :amount_cents, -> { Integer }, optional: false, nullable: false
          field :payment_timestamp, -> { String }, optional: true, nullable: false
          field :status, -> { Candid::PatientPayments::V3::Types::PatientPaymentStatus }, optional: true, nullable: false
