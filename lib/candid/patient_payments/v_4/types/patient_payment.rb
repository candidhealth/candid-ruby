    ...
    module V4
      module Types
        class PatientPayment < Internal::Types::Model
          ...
          field :payment_source, -> { Candid::Financials::Types::PatientTransactionSource }, optional: false, nullable: false
          ...
          field :payment_method_detail, -> { Candid::PatientPayments::V4::Types::PaymentMethodDetail }, optional: true, nullable: false
        end
      end
    end
  end
