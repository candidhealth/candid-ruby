    ...
    module Patients
      module V1
        class Client
          ...
          # @option request_options [Integer] :timeout_in_seconds
          # @option params [Candid::PreEncounter::Common::Types::PatientId] :id
          # @option params [Candid::PreEncounter::Patients::V1::Types::EligibilityAuditEventType, nil] :event_types
          # @option params [String, nil] :coverage_id
          # @option params [String, nil] :appointment_id
          # @option params [String, nil] :page_token
          # @option params [Integer, nil] :limit
          #
          # @return [Candid::PreEncounter::Patients::V1::Types::EligibilityTimelinePage]
