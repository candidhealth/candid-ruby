  ...
  module ServiceLines
    module V2
      class Client
        ...
        # @param params [Candid::ServiceLines::V2::Types::ServiceLineCreateStandalone]
        ...
        def create(request_options: {}, **params)
          ...
          if code.between?(200, 299)
            Candid::ServiceLines::V2::Types::ServiceLine.load(response.body)
          else
        ...
        # @param request_options [Hash]
        # @param params [Candid::ServiceLines::V2::Types::UniversalServiceLineCreateStandalone]
        # @option request_options [String] :base_url
        # @option request_options [Hash{String => Object}] :additional_headers
        # @option request_options [Hash{String => Object}] :additional_query_parameters
        # @option request_options [Hash{String => Object}] :additional_body_parameters
        ...
        # @param request_options [Hash]
        # @param params [Candid::ServiceLines::V2::Types::UniversalServiceLineUpdate]
        # @option request_options [String] :base_url
        # @option request_options [Hash{String => Object}] :additional_headers
        # @option request_options [Hash{String => Object}] :additional_query_parameters
        # @option request_options [Hash{String => Object}] :additional_body_parameters
        ...
        # @param request_options [Hash]
        # @param params [Candid::ServiceLines::V2::Types::ServiceLineUpdate]
        # @option request_options [String] :base_url
        # @option request_options [Hash{String => Object}] :additional_headers
        # @option request_options [Hash{String => Object}] :additional_query_parameters
        # @option request_options [Hash{String => Object}] :additional_body_parameters
