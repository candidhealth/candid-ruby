    ...
    module V2
      module Types
        class ServiceLine < Internal::Types::Model
          ...
          field :service_line_era_data, -> { Candid::ServiceLines::V2::Types::ServiceLineEraData }, optional: true, nullable: false
          field :service_line_manual_adjustments, -> { Internal::Types::Array[Candid::ServiceLines::V2::Types::ServiceLineAdjustment] }, optional: true, nullable: false
          field :related_invoices, -> { Internal::Types::Array[Candid::Invoices::Types::Invoice] }, optional: true, nullable: false
          field :related_invoice_info, -> { Internal::Types::Array[Candid::Invoices::V2::Types::InvoiceInfo] }, optional: true, nullable: false
          field :denial_reason, -> { Candid::ServiceLines::V2::Types::ServiceLineDenialReason }, optional: true, nullable: false
          ...
          field :date_of_service_range, -> { Candid::Commons::Types::DateRangeOptionalEnd }, optional: false, nullable: false
