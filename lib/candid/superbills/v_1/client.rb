  ...
  module Superbills
    module V1
      class Client
        ...
        # @param params [Candid::Superbills::V1::Types::CreateSuperbillRequest]
        ...
        def create_superbill(request_options: {}, **params)
          ...
          request = Candid::Internal::JSON::Request.new(
            ...
            body: Candid::Superbills::V1::Types::CreateSuperbillRequest.new(params).to_h,
          ...
          if code.between?(200, 299)
            Candid::Superbills::V1::Types::SuperbillResponse.load(response.body)
          else
