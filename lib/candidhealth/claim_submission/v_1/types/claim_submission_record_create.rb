    ...
    module V1
      module Types
        ...
        class ClaimSubmissionRecordCreate
          ...
          # @return [CandidApiClient::ClaimSubmission::V1::Types::ClaimSubmissionRecordCreate]
          def initialize(submitted_at:, claim_frequency_code: OMIT, payer_responsibility: OMIT,
