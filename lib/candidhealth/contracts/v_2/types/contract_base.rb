    ...
    module V2
      module Types
        class ContractBase
          ...
          # @return [CandidApiClient::Contracts::V2::Types::ContractBase]
          def initialize(effective_date:, regions:, commercial_insurance_types:, medicare_insurance_types:, medicaid_insurance_types:, expiration_date: OMIT, contract_status: OMIT,
                         authorized_signatory: OMIT, additional_properties: nil)
