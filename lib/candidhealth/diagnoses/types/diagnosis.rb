...
module CandidApiClient
  class Diagnoses
    class Diagnosis
      attr_reader :diagnosis_id, :created_at, :updated_at, :encounter_id, :name, :code_type, :code,
                  :additional_properties

      # @param diagnosis_id [Diagnoses::DIAGNOSIS_ID]
      ...
      def initialize(diagnosis_id:, created_at:, updated_at:, encounter_id:, code_type:, code:, name: nil,
      ...
      def self.from_json(json_object:)
        ...
        code = struct.code
        new(diagnosis_id: diagnosis_id, created_at: created_at, updated_at: updated_at, encounter_id: encounter_id,
            name: name, code_type: code_type, code: code, additional_properties: struct)
      end
