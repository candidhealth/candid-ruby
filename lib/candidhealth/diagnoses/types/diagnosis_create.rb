...
module CandidApiClient
  class Diagnoses
    class DiagnosisCreate
      attr_reader :name, :code_type, :code, :additional_properties
      ...
      # @return [Diagnoses::DiagnosisCreate]
      def initialize(code_type:, code:, name: nil, additional_properties: nil)
      ...
      def self.from_json(json_object:)
        ...
        code = struct.code
        new(name: name, code_type: code_type, code: code, additional_properties: struct)
      end
      ...
      # @return [JSON]
      def to_json(*_args)
        { "name": @name, "code_type": @code_type, "code": @code }.to_json
      end
