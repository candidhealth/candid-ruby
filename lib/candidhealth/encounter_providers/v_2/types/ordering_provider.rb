    ...
    module V2
      module Types
        class OrderingProvider
          ...
          # @return [CandidApiClient::EncounterProviders::V2::Types::OrderingProvider]
          ...
          # Deserialize a JSON object to an instance of OrderingProvider
          #
          ...
          # Serialize an instance of OrderingProvider to a JSON object
          #
          # @return [String]
          def to_json(*_args)
            @_field_set&.to_json
