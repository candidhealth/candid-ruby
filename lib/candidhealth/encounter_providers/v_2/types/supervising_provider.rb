    ...
    module V2
      module Types
        class SupervisingProvider
          ...
          # @return [CandidApiClient::EncounterProviders::V2::Types::SupervisingProvider]
          ...
          # Deserialize a JSON object to an instance of SupervisingProvider
          #
          ...
          # Serialize an instance of SupervisingProvider to a JSON object
          #
          # @return [String]
          def to_json(*_args)
            @_field_set&.to_json
