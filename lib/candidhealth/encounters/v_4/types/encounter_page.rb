...
module CandidApiClient
  module Encounters
    module V4
      module Types
        class EncounterPage
          # @return [Array<CandidApiClient::Encounters::V4::Types::Encounter>]
          attr_reader :items
          # @return [String]
          ...
          # @param items [Array<CandidApiClient::Encounters::V4::Types::Encounter>]
          ...
          def self.from_json(json_object:)
            ...
            items = parsed_json["items"]&.map do |item|
              item = item.to_json
              CandidApiClient::Encounters::V4::Types::Encounter.from_json(json_object: item)
            end
