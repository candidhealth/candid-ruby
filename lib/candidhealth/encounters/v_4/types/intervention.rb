    ...
    module V4
      module Types
        class Intervention
          ...
          # @return [CandidApiClient::Encounters::V4::Types::Medication] Required when `type` is `allopathic`.
          attr_reader :medication
          # @return [Array<CandidApiClient::Encounters::V4::Types::Lab>] Required when `type` is `tests`.
          attr_reader :labs
          ...
          #  'Labs'"
          # @param medication [CandidApiClient::Encounters::V4::Types::Medication] Required when `type` is `allopathic`.
          # @param labs [Array<CandidApiClient::Encounters::V4::Types::Lab>] Required when `type` is `tests`.
          # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
          # @return [CandidApiClient::Encounters::V4::Types::Intervention]
          def initialize(name:, category:, description: OMIT, medication: OMIT, labs: OMIT, additional_properties: nil)
            @name = name
            @category = category
          ...
          def self.from_json(json_object:)
            ...
            if parsed_json["medication"].nil?
              ...
              medication = CandidApiClient::Encounters::V4::Types::Medication.from_json(json_object: medication)
            end
            labs = parsed_json["labs"]&.map do |item|
              item = item.to_json
              CandidApiClient::Encounters::V4::Types::Lab.from_json(json_object: item)
            end
            new(
              name: name,
              category: category,
          ...
          def self.validate_raw(obj:)
            ...
            obj.medication.nil? || CandidApiClient::Encounters::V4::Types::Medication.validate_raw(obj: obj.medication)
