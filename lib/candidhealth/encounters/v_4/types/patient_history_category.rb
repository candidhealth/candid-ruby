    ...
    module V4
      module Types
        class PatientHistoryCategory
          ...
          # @return [Array<CandidApiClient::Encounters::V4::Types::IntakeQuestion>] Must contain at least one item.
          ...
          # @param questions [Array<CandidApiClient::Encounters::V4::Types::IntakeQuestion>] Must contain at least one item.
          # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
          # @return [CandidApiClient::Encounters::V4::Types::PatientHistoryCategory]
          def initialize(category:, questions:, additional_properties: nil)
            @category = category
            @questions = questions
            @additional_properties = additional_properties
            @_field_set = { "category": category, "questions": questions }
          end
          ...
          def self.from_json(json_object:)
            ...
            questions = parsed_json["questions"]&.map do |item|
              item = item.to_json
              CandidApiClient::Encounters::V4::Types::IntakeQuestion.from_json(json_object: item)
            end
            new(
              category: category,
              questions: questions,
