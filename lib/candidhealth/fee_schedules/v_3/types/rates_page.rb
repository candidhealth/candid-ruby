    ...
    module V3
      module Types
        class RatesPage
          ...
          # @param rates [Array<CandidApiClient::FeeSchedules::V3::Types::Rate>]
          ...
          def initialize(rates:, prev_page_token: OMIT, next_page_token: OMIT, additional_properties: nil)
            @rates = rates
          ...
          def self.from_json(json_object:)
            ...
            rates = parsed_json["rates"]&.map do |item|
              item = item.to_json
