  ...
  module HealthCareCodeInformation
    module V1
      module Types
        ...
        class OtherProcedureInformation
          ...
          # @param other_procedure_date [DateTime] An [RFC 3339, section 5.6 datetime](https://ijmacd.github.io/rfc3339-iso8601/).
          #  For example, 2017-07-21T17:32:28Z.
          #  In practice, only the date portion of this is used for claim submission, so
          #  midnight time is fine.
          ...
          # @return [CandidApiClient::HealthCareCodeInformation::V1::Types::OtherProcedureInformation]
          def initialize(other_procedure_code_qualifier:, other_procedure_code:, other_procedure_date:, id: OMIT,
          ...
          # Deserialize a JSON object to an instance of OtherProcedureInformation
          #
          ...
          # Serialize an instance of OtherProcedureInformation to a JSON object
          #
          # @return [String]
          def to_json(*_args)
            @_field_set&.to_json
