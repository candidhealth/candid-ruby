...
module CandidApiClient
  class Individual
    class PatientCreate
      attr_reader :phone_numbers, :phone_consent, :email, :email_consent, :external_id, :date_of_birth, :address,
      ...
      # @return [Individual::PatientCreate]
      def initialize(external_id:, date_of_birth:, address:, first_name:, last_name:, gender:, phone_numbers: nil,
                     phone_consent: nil, email: nil, email_consent: nil, additional_properties: nil)
      ...
      def self.from_json(json_object:)
        ...
        new(phone_numbers: phone_numbers, phone_consent: phone_consent, email: email, email_consent: email_consent,
            external_id: external_id, date_of_birth: date_of_birth, address: address, first_name: first_name, last_name: last_name, gender: gender, additional_properties: struct)
      end
