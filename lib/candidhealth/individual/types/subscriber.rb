  ...
  module Individual
    module Types
      class Subscriber
        ...
        # @param insurance_card [CandidApiClient::InsuranceCards::V2::Types::InsuranceCard]
        ...
        # @return [CandidApiClient::Individual::Types::Subscriber]
        def initialize(individual_id:, insurance_card:, patient_relationship_to_subscriber_code:, first_name:, last_name:, gender:, date_of_birth: OMIT,
        ...
        def self.from_json(json_object:)
          ...
          if parsed_json["insurance_card"].nil?
            ...
            insurance_card = CandidApiClient::InsuranceCards::V2::Types::InsuranceCard.from_json(json_object: insurance_card)
          end
        ...
        def self.validate_raw(obj:)
          ...
          CandidApiClient::InsuranceCards::V2::Types::InsuranceCard.validate_raw(obj: obj.insurance_card)
