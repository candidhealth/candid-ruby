...
module CandidApiClient
  class Individual
    class SubscriberBase
      attr_reader :patient_relationship_to_subscriber_code, :date_of_birth, :address, :first_name, :last_name, :gender,
      ...
      # @return [Individual::SubscriberBase]
      def initialize(patient_relationship_to_subscriber_code:, first_name:, last_name:, gender:, date_of_birth: nil,
      ...
      # Deserialize a JSON object to an instance of SubscriberBase
      #
      ...
      def self.from_json(json_object:)
        ...
        new(patient_relationship_to_subscriber_code: patient_relationship_to_subscriber_code,
            date_of_birth: date_of_birth, address: address, first_name: first_name, last_name: last_name, gender: gender, additional_properties: struct)
      end

      # Serialize an instance of SubscriberBase to a JSON object
      #
      # @return [JSON]
      def to_json(*_args)
        {
