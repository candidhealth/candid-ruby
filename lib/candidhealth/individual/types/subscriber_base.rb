  ...
  module Individual
    module Types
      class SubscriberBase
        ...
        # @return [CandidApiClient::Individual::Types::SubscriberBase]
        def initialize(patient_relationship_to_subscriber_code:, first_name:, last_name:, gender:, date_of_birth: OMIT,
