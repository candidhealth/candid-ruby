  ...
  module Individual
    module Types
      class SubscriberCreate
        ...
        # @return [CandidApiClient::Individual::Types::SubscriberCreate]
        def initialize(insurance_card:, patient_relationship_to_subscriber_code:, first_name:, last_name:, gender:,
                       date_of_birth: OMIT, address: OMIT, additional_properties: nil)
        ...
        def self.from_json(json_object:)
          ...
          if parsed_json["insurance_card"].nil?
            ...
            insurance_card = CandidApiClient::InsuranceCards::V2::Types::InsuranceCardCreate.from_json(json_object: insurance_card)
          end
        ...
        def self.validate_raw(obj:)
          CandidApiClient::InsuranceCards::V2::Types::InsuranceCardCreate.validate_raw(obj: obj.insurance_card)
