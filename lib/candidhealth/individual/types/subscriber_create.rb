...
require_relative "../../insurance_cards/v_2/types/insurance_card_create"
...
module CandidApiClient
  class Individual
    class SubscriberCreate
      attr_reader :insurance_card, :patient_relationship_to_subscriber_code, :date_of_birth, :address, :first_name,
                  :last_name, :gender, :additional_properties

      # @param insurance_card [InsuranceCards::V2::InsuranceCardCreate]
      ...
      # @return [Individual::SubscriberCreate]
      def initialize(insurance_card:, patient_relationship_to_subscriber_code:, first_name:, last_name:, gender:,
                     date_of_birth: nil, address: nil, additional_properties: nil)
        # @type [InsuranceCards::V2::InsuranceCardCreate]
      ...
      # Deserialize a JSON object to an instance of SubscriberCreate
      #
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["insurance_card"].nil?
          ...
          insurance_card = InsuranceCards::V2::InsuranceCardCreate.from_json(json_object: insurance_card)
        end
        ...
        new(insurance_card: insurance_card,
      ...
      # Serialize an instance of SubscriberCreate to a JSON object
      #
      # @return [JSON]
      def to_json(*_args)
        {
      ...
      def self.validate_raw(obj:)
        InsuranceCards::V2::InsuranceCardCreate.validate_raw(obj: obj.insurance_card)
