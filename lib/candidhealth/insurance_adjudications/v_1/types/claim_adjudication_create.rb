    ...
    module V1
      module Types
        class ClaimAdjudicationCreate
          # @return [CandidApiClient::EraCommons::Types::ClaimStatusCodeCreate]
          attr_reader :claim_status_code
          # @return [Integer]
          ...
          # @param claim_status_code [CandidApiClient::EraCommons::Types::ClaimStatusCodeCreate]
          ...
          # @return [CandidApiClient::InsuranceAdjudications::V1::Types::ClaimAdjudicationCreate]
