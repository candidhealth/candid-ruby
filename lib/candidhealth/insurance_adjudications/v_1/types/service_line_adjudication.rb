    ...
    module V1
      module Types
        class ServiceLineAdjudication
          # @return [String]
          attr_reader :service_line_adjudication_id
          ...
          # @param service_line_adjudication_id [String]
          ...
          # @return [CandidApiClient::InsuranceAdjudications::V1::Types::ServiceLineAdjudication]
          def initialize(service_line_adjudication_id:, carcs:, rarcs:, denial_reason: OMIT, insurance_allowed_amount_cents: OMIT,
                         insurance_paid_amount_cents: OMIT, deductible_amount_cents: OMIT, coinsurance_amount_cents: OMIT, copay_amount_cents: OMIT, additional_properties: nil)
