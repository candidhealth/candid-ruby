    ...
    module V1
      module Types
        class InsurancePaymentsPage
          # @return [Array<CandidApiClient::InsurancePayments::V1::Types::InsurancePayment>]
          attr_reader :items
          # @return [String]
          ...
          # @param items [Array<CandidApiClient::InsurancePayments::V1::Types::InsurancePayment>]
          ...
          def self.from_json(json_object:)
            ...
            items = parsed_json["items"]&.map do |item|
              item = item.to_json
              CandidApiClient::InsurancePayments::V1::Types::InsurancePayment.from_json(json_object: item)
            end
