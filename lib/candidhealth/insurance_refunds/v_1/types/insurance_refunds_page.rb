  ...
  module InsuranceRefunds
    module V1
      class InsuranceRefundsPage
        ...
        # @param items [Array<InsuranceRefunds::V1::InsuranceRefund>]
        ...
        def initialize(items:, prev_page_token: nil, next_page_token: nil, additional_properties: nil)
          # @type [Array<InsuranceRefunds::V1::InsuranceRefund>]
          @items = items
        ...
        def self.from_json(json_object:)
          ...
          items = parsed_json["items"]&.map do |v|
            v = v.to_json
            InsuranceRefunds::V1::InsuranceRefund.from_json(json_object: v)
          end
