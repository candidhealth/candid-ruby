    ...
    module V2
      module Types
        class OrganizationProvider
          ...
          # @return [CandidApiClient::OrganizationProviders::V2::Types::EmploymentStatus] The employment status for the provider.
          attr_reader :employment_status
          # @return [String] The employment start date for the provider.
          attr_reader :employment_start_date
          # @return [String] The employment termination date for the provider.
          ...
          # @param employment_status [CandidApiClient::OrganizationProviders::V2::Types::EmploymentStatus] The employment status for the provider.
          # @param employment_start_date [String] The employment start date for the provider.
          # @param employment_termination_date [String] The employment termination date for the provider.
          ...
          # @return [CandidApiClient::OrganizationProviders::V2::Types::OrganizationProvider]
          def initialize(organization_provider_id:, employment_status:, npi:, is_rendering:, is_billing:, provider_type:, license_type:, employment_start_date: OMIT,
                         employment_termination_date: OMIT, first_name: OMIT, last_name: OMIT, organization_name: OMIT, tax_id: OMIT, taxonomy_code: OMIT, ptan: OMIT, medicaid_provider_id: OMIT, addresses: OMIT, additional_properties: nil)
          ...
          def self.validate_raw(obj:)
            ...
            obj.employment_status.is_a?(CandidApiClient::OrganizationProviders::V2::Types::EmploymentStatus) != false || raise("Passed value for field obj.employment_status is not the expected type, validation failed.")
