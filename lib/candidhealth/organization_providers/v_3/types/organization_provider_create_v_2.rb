    ...
    module V3
      module Types
        class OrganizationProviderCreateV2
          ...
          # @return [Array<CandidApiClient::Identifiers::Types::IdentifierCreate>] A provider's qualifications such as PTAN, Medicaid Provider Id, etc.
          ...
          # @param qualifications [Array<CandidApiClient::Identifiers::Types::IdentifierCreate>] A provider's qualifications such as PTAN, Medicaid Provider Id, etc.
          # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
          # @return [CandidApiClient::OrganizationProviders::V3::Types::OrganizationProviderCreateV2]
