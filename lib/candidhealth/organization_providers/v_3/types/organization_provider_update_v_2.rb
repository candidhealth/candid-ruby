    ...
    module V3
      module Types
        class OrganizationProviderUpdateV2
          ...
          # @return [Array<CandidApiClient::Identifiers::Types::UpdatableIdentifier>] Provider's qualifications (medicare provider number, medicaid provider number,
          #  etc.)
          ...
          # @param qualifications [Array<CandidApiClient::Identifiers::Types::UpdatableIdentifier>] Provider's qualifications (medicare provider number, medicaid provider number,
          #  etc.)
          # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
          # @return [CandidApiClient::OrganizationProviders::V3::Types::OrganizationProviderUpdateV2]
