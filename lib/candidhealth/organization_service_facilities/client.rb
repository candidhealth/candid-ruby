  ...
  module OrganizationServiceFacilities
    class Client
      ...
      def initialize(request_client:)
        @v_2 = CandidApiClient::OrganizationServiceFacilities::V2::V2Client.new(request_client: request_client)
      end
    end
    ...
    class AsyncClient
      ...
      def initialize(request_client:)
        @v_2 = CandidApiClient::OrganizationServiceFacilities::V2::AsyncV2Client.new(request_client: request_client)
      end
    end
  end
end
