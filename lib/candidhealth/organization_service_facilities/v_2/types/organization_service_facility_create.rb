  ...
  module OrganizationServiceFacilities
    module V2
      class OrganizationServiceFacilityCreate
        ...
        # @return [OrganizationServiceFacilities::V2::OrganizationServiceFacilityCreate]
        def initialize(name:, aliases:, telecoms:, address:, description: nil, npi: nil, status: nil, operational_status: nil, mode: nil,
                       type: nil, physical_type: nil, additional_properties: nil)
