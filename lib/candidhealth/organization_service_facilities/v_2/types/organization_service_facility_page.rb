    ...
    module V2
      module Types
        class OrganizationServiceFacilityPage
          # @return [Array<CandidApiClient::OrganizationServiceFacilities::V2::Types::OrganizationServiceFacility>]
          attr_reader :items
          # @return [String]
          ...
          # @param items [Array<CandidApiClient::OrganizationServiceFacilities::V2::Types::OrganizationServiceFacility>]
          ...
          def self.from_json(json_object:)
            ...
            items = parsed_json["items"]&.map do |item|
              item = item.to_json
              CandidApiClient::OrganizationServiceFacilities::V2::Types::OrganizationServiceFacility.from_json(json_object: item)
            end
