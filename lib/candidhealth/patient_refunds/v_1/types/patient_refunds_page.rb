    ...
    module V1
      module Types
        class PatientRefundsPage
          # @return [Array<CandidApiClient::PatientRefunds::V1::Types::PatientRefund>]
          attr_reader :items
          # @return [String]
          ...
          # @param items [Array<CandidApiClient::PatientRefunds::V1::Types::PatientRefund>]
          ...
          def self.from_json(json_object:)
            ...
            items = parsed_json["items"]&.map do |item|
              item = item.to_json
              CandidApiClient::PatientRefunds::V1::Types::PatientRefund.from_json(json_object: item)
            end
