...
module CandidApiClient
  module Payers
    module V3
      module Types
        class PayerPage
          # @return [Array<CandidApiClient::Payers::V3::Types::Payer>]
          attr_reader :items
          # @return [String]
          ...
          # @param items [Array<CandidApiClient::Payers::V3::Types::Payer>]
          ...
          def self.from_json(json_object:)
            ...
            items = parsed_json["items"]&.map do |item|
              item = item.to_json
              CandidApiClient::Payers::V3::Types::Payer.from_json(json_object: item)
            end
