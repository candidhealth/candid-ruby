...
module CandidApiClient
  module PreEncounter
    class CoveragesClient
      ...
      #  individual.
      #
      # @param request [Hash] Request of type CandidApiClient::PreEncounter::Coverages::Types::MutableCoverage, as a Hash
      #   * :status (CandidApiClient::PreEncounter::Coverages::Types::CoverageStatus)
      #   * :subscriber (Hash)
      #     * :name (Hash)
      #       * :family (String)
      #       * :given (Array<String>)
      ...
      #     * :group_number (String)
      #     * :name (String)
      #     * :type (CandidApiClient::PreEncounter::Coverages::Types::CoverageType)
      #     * :period (Hash)
      #       * :start (Date)
      #       * :end_ (Date)
      ...
      def create(request:, request_options: nil)
        ...
        **(request_options&.additional_headers || {})
          ...
          req.url "#{@request_client.get_url(request_options: request_options)}/coverages"
        end
        CandidApiClient::PreEncounter::Coverages::Types::Coverage.from_json(json_object: response.body)
      end
      ...
      # @example
      #  api = CandidApiClient::Client.new(base_url: "https://api.example.com", environment: CandidApiClient::Environment::PRODUCTION)
      #  api.pre_encounter.coverages.update(
      ...
      def update(id:, version:, request:, request_options: nil)
        ...
        **(request_options&.additional_headers || {})
          ...
          req.body = { **(request || {}), **(request_options&.additional_body_parameters || {}) }.compact
          req.url "#{@request_client.get_url(request_options: request_options)}/coverages/#{id}/#{version}"
        end
        CandidApiClient::PreEncounter::Coverages::Types::Coverage.from_json(json_object: response.body)
      end
      ...
      # @example
      #  api = CandidApiClient::Client.new(base_url: "https://api.example.com", environment: CandidApiClient::Environment::PRODUCTION)
      #  api.pre_encounter.coverages.get(id: "d5e9c84f-c2b2-4bf4-b4b0-7ffd7a9ffc32")
      def get(id:, request_options: nil)
        ...
        **(request_options&.additional_headers || {})
          ...
          req.url "#{@request_client.get_url(request_options: request_options)}/coverages/#{id}"
        end
        CandidApiClient::PreEncounter::Coverages::Types::Coverage.from_json(json_object: response.body)
      end
      ...
      # @param id [String]
      # @param request_options [CandidApiClient::RequestOptions]
      # @return [Array<CandidApiClient::PreEncounter::Coverages::Types::Coverage>]
      # @example
      #  api = CandidApiClient::Client.new(base_url: "https://api.example.com", environment: CandidApiClient::Environment::PRODUCTION)
      #  api.pre_encounter.coverages.get_history(id: "d5e9c84f-c2b2-4bf4-b4b0-7ffd7a9ffc32")
      def get_history(id:, request_options: nil)
        ...
        **(request_options&.additional_headers || {})
          ...
          req.url "#{@request_client.get_url(request_options: request_options)}/coverages/#{id}/history"
        end
        parsed_json = JSON.parse(response.body)
        parsed_json&.map do |item|
          item = item.to_json
          CandidApiClient::PreEncounter::Coverages::Types::Coverage.from_json(json_object: item)
        end
      end
      ...
      # @example
      #  api = CandidApiClient::Client.new(base_url: "https://api.example.com", environment: CandidApiClient::Environment::PRODUCTION)
      #  api.pre_encounter.coverages.get_multi(patient_id: "string")
      def get_multi(patient_id: nil, request_options: nil)
        ...
        **(request_options&.additional_headers || {})
          ...
          req.params = { **(request_options&.additional_query_parameters || {}), "patientId": patient_id }.compact
          req.url "#{@request_client.get_url(request_options: request_options)}/coverages"
        end
        parsed_json = JSON.parse(response.body)
        parsed_json&.map do |item|
      ...
      # @example
      #  api = CandidApiClient::Client.new(base_url: "https://api.example.com", environment: CandidApiClient::Environment::PRODUCTION)
      #  api.pre_encounter.coverages.scan(since: DateTime.parse(2024-01-15T09:30:00.000Z))
      def scan(since:, request_options: nil)
        ...
        **(request_options&.additional_headers || {})
          ...
          req.url "#{@request_client.get_url(request_options: request_options)}/coverages/updates/scan"
        end
        parsed_json = JSON.parse(response.body)
        parsed_json&.map do |item|
          item = item.to_json
