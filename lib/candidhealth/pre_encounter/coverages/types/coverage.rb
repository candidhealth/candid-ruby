    ...
    module Coverages
      module Types
        ...
        class Coverage
          ...
          # @return [CandidApiClient::PreEncounter::Coverages::Types::CoverageStatus] The status indiciating if the coverage is active or not.
          attr_reader :status
          # @return [CandidApiClient::PreEncounter::Coverages::Types::Subscriber] The party who has signed-up for or 'owns' the contractual relationship to the
          ...
          attr_reader :patient
          # @return [CandidApiClient::PreEncounter::Coverages::Types::InsurancePlan]
          ...
          # @param status [CandidApiClient::PreEncounter::Coverages::Types::CoverageStatus] The status indiciating if the coverage is active or not.
          # @param subscriber [CandidApiClient::PreEncounter::Coverages::Types::Subscriber] The party who has signed-up for or 'owns' the contractual relationship to the
          #  policy or to whom the benefit of the policy for services rendered to them or
          #  their family is due.
          ...
          # @param insurance_plan [CandidApiClient::PreEncounter::Coverages::Types::InsurancePlan]
          # @param verified [Boolean] A boolean indicating if the coverage has been verified by a user.
          # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
          # @return [CandidApiClient::PreEncounter::Coverages::Types::Coverage]
          def initialize(id:, organization_id:, deactivated:, version:, updated_at:, updating_user_id:, status:,
            ...
            @_field_set = {
              ...
              "updatingUserId": updating_user_id,
              "status": status,
              "subscriber": subscriber,
              "relationship": relationship,
              "patient": patient,
          ...
          def self.from_json(json_object:)
            ...
            updating_user_id = struct["updatingUserId"]
            status = struct["status"]
            if parsed_json["subscriber"].nil?
              subscriber = nil
            else
              subscriber = parsed_json["subscriber"].to_json
              subscriber = CandidApiClient::PreEncounter::Coverages::Types::Subscriber.from_json(json_object: subscriber)
            end
            relationship = struct["relationship"]
            patient = struct["patient"]
            if parsed_json["insurancePlan"].nil?
              insurance_plan = nil
            else
              insurance_plan = parsed_json["insurancePlan"].to_json
              insurance_plan = CandidApiClient::PreEncounter::Coverages::Types::InsurancePlan.from_json(json_object: insurance_plan)
            end
          ...
          def self.validate_raw(obj:)
            ...
            obj.status.is_a?(CandidApiClient::PreEncounter::Coverages::Types::CoverageStatus) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
            CandidApiClient::PreEncounter::Coverages::Types::Subscriber.validate_raw(obj: obj.subscriber)
            ...
            CandidApiClient::PreEncounter::Coverages::Types::InsurancePlan.validate_raw(obj: obj.insurance_plan)
