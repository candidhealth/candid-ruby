    ...
    module Coverages
      module Types
        class InsurancePlan
          ...
          # @return [String]
          attr_reader :name
          # @return [CandidApiClient::PreEncounter::Coverages::Types::CoverageType]
          attr_reader :type
          ...
          # @param name [String]
          # @param type [CandidApiClient::PreEncounter::Coverages::Types::CoverageType]
          ...
          def initialize(member_id:, payer_id:, payer_name:, group_number: OMIT, name: OMIT, type: OMIT, period: OMIT,
                         insurance_card_image_locator: OMIT, additional_properties: nil)
            @member_id = member_id
            @payer_id = payer_id
          ...
          def self.from_json(json_object:)
            ...
            member_id = struct["memberId"]
            payer_id = struct["payerId"]
            payer_name = struct["payerName"]
            group_number = struct["groupNumber"]
            name = struct["name"]
            type = struct["type"]
            ...
            insurance_card_image_locator = struct["insuranceCardImageLocator"]
            new(
              member_id: member_id,
              payer_id: payer_id,
              payer_name: payer_name,
          ...
          def self.validate_raw(obj:)
            ...
            obj.type&.is_a?(CandidApiClient::PreEncounter::Coverages::Types::CoverageType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
