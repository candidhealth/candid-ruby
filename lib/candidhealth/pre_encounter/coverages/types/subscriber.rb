    ...
    module Coverages
      module Types
        class Subscriber
          ...
          # @return [CandidApiClient::PreEncounter::Coverages::Types::Subscriber]
          def initialize(name:, date_of_birth:, gender:, additional_properties: nil)
            @name = name
            @date_of_birth = date_of_birth
            @gender = gender
            @additional_properties = additional_properties
            @_field_set = { "name": name, "dateOfBirth": date_of_birth, "gender": gender }
          end
          ...
          def self.from_json(json_object:)
            ...
            date_of_birth = (Date.parse(parsed_json["dateOfBirth"]) unless parsed_json["dateOfBirth"].nil?)
