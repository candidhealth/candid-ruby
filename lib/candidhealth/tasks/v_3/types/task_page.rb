...
module CandidApiClient
  module Tasks
    module V3
      module Types
        class TaskPage
          # @return [Array<CandidApiClient::Tasks::V3::Types::Task>]
          attr_reader :items
          # @return [String]
          ...
          # @param items [Array<CandidApiClient::Tasks::V3::Types::Task>]
          ...
          # Deserialize a JSON object to an instance of TaskPage
          #
          ...
          def self.from_json(json_object:)
            ...
            items = parsed_json["items"]&.map do |item|
              item = item.to_json
              CandidApiClient::Tasks::V3::Types::Task.from_json(json_object: item)
            end
          ...
          # Serialize an instance of TaskPage to a JSON object
          #
          # @return [String]
          def to_json(*_args)
            @_field_set&.to_json
