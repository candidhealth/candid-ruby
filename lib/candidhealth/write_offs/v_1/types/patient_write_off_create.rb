  ...
  module WriteOffs
    module V1
      class PatientWriteOffCreate
        attr_reader :write_off_timestamp, :write_off_note, :write_off_reason, :service_line_id, :amount_cents,
        ...
        # @return [WriteOffs::V1::PatientWriteOffCreate]
        def initialize(write_off_timestamp:, write_off_reason:, service_line_id:, amount_cents:, write_off_note: nil,
        ...
        def self.from_json(json_object:)
          ...
          new(write_off_timestamp: write_off_timestamp, write_off_note: write_off_note,
              write_off_reason: write_off_reason, service_line_id: service_line_id, amount_cents: amount_cents, additional_properties: struct)
        end
