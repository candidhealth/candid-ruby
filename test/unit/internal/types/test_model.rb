...
describe Candid::Internal::Types::Model do
  ...
  class ExampleModel < Candid::Internal::Types::Model
    field :name, String
  ...
  class ExampleChild < Candid::Internal::Types::Model
    field :value, String
  end

  class ExampleParent < Candid::Internal::Types::Model
  ...
  describe "#inspect" do
    class SensitiveModel < Candid::Internal::Types::Model
