...
describe Candid::Internal::Types::Union do
  class Rectangle < Candid::Internal::Types::Model
    literal :type, "square"

    field :area, Float
  end

  class Circle < Candid::Internal::Types::Model
    literal :type, "circle"

    field :area, Float
  end

  class Pineapple < Candid::Internal::Types::Model
