...
describe Candid::Internal::Types::Utils do
  Utils = Candid::Internal::Types::Utils

  module TestUtils
    class M < Candid::Internal::Types::Model
      field :value, String
    end

    class UnionMemberA < Candid::Internal::Types::Model
      literal :type, "A"
      field :only_on_a, String
    end

    class UnionMemberB < Candid::Internal::Types::Model
      literal :type, "B"
    ...
    SymbolStringHash = Candid::Internal::Types::Hash[Symbol, String]
    SymbolModelHash = -> { Candid::Internal::Types::Hash[Symbol, TestUtils::M] }
  end
  ...
  describe ".coerce" do
    ...
    describe "Array" do
      StringArray = Candid::Internal::Types::Array[String]
      ModelArray = -> { Candid::Internal::Types::Array[TestUtils::M] }
      UnionArray = -> { Candid::Internal::Types::Array[TestUtils::U] }
